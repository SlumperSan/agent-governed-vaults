...
Generated from `notes/idea-backlog.md` by `scripts/backlog-index.py`. Source is 54 lines; this index exists so a loop tick can answer "what is unblocked?" without reading all of it.
...
- **L14** — 1
  - status: open
  - section: P0 — the moat depends on these
- **L15** — 2
  - status: open
  - section: P0 — the moat depends on these
- **L16** — 3
...
- **L31** — 8
  - status: open
  - section: P2 — distribution and authority
- **L32** — 9
  - status: open
  - section: P2 — distribution and authority
- **L33** — 10
