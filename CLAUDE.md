...
The single author identity for this repository is
...
changed. If a commit you are about to make would carry the old address, stop and say so rather than
changing the config yourself.
