...
rows is a re-derivation against the merged code and is deliberately not decided here — it was
done separately and mutation-verified at `c3c789ba`, an ancestor of `52d10aee`.** In both, internal accounting is measured across a full external call
