...
> **FIXED — correction 2026-09-04.** The three sentences that followed said H-9 was "unfixed on
> `protocol/main`", that the fix was "written and in review as PR #98", and that
> "`_fullNavWad` is unreachable on the launch configuration". The first two are withdrawn as
