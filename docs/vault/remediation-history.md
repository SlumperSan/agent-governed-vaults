...
`VaultCore` began the session with 1,560 B of EIP-170 margin and ended with **1,014 B** (a dated record — the live figure is **3,926 B** since PR #90; see [[vaultcore]]). The path was non-monotonic: H-4 cost 375 and M-4 cost 3 (→1,182); **M-11 returned 336** (→1,518); M-2 spent 504 on escrow routing. M-2 was affordable **only because M-11 came first**. H-5/H-6/H-9 and M-15's exit-side were unfixed because they land in `VaultCore` and did not fit at that budget — which is also why the [[delegatecall-split-rejected]] was considered, then dropped once sub-vaults were disabled. **That is the record, not the position today**: H-9 was fixed in code 2026-09-01, and at 3,926 B the rest fit; the dormancy defers them now.
