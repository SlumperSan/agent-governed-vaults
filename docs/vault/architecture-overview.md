...
- **commitment C-n**, the architecture design commitments from `docs/ARCHITECTURE.md`:
...
- **audit C-n**, the critical findings from the AI pre-audit: audit C-1 = *empty electorate*
