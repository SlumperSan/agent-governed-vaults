...
weighing against the brief's `(member, operator)` HWM key (C-3/CM-4 in the phased build plan), which
...
plan: (a) the reveal-deadline forfeiture mechanic should assume a meaningful fraction
