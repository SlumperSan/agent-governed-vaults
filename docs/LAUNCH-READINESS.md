...
| 10 | **Vendored GPL-2.0-or-later / MIT math under a BUSL repo** | License challenge to the distribution | An owner decision, flagged in the audit handoff as out of scope for the technical audit; not a deployment-mechanics risk. This row was never a go/no-go gate — §1 has no such row — and it is not one now |
