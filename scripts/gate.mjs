...
// The entrypoints CI syntax-checks. No count here: the previous wording said "six" while listing
// seven, and a replacement that said "seven as of <date>" was self-refuting - it wrote the count
// in the same sentence telling you not to. Read the array.
// They have no unit tests -- they are exercised by hand
