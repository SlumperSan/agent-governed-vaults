...
const BANNER_STATUS = 'Not deployed to mainnet. No mainnet deployment of the current code exists, and the Base Sepolia deployment is a testnet trial with no real value at stake.';
