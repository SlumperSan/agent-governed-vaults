/**
 * Client entry for who-its-for.html. One of eight; each is loaded by exactly one entry
 * HTML and pulls in exactly one page body.
 *
 * The glob rather than a plain import is the seam described in
 * src/shell/pageBody.ts: Integrate owns src/pages/WhoItsForPage.tsx, Shell owns this
...
const modules = import.meta.glob('./pages/WhoItsForPage.{tsx,jsx}', { eager: true });

hydrate('who-its-for.html', pickPage(modules, 'WhoItsForPage'));
