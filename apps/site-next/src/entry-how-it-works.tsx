/**
 * Client entry for how-it-works.html. One of eight; each is loaded by exactly one entry
 * HTML and pulls in exactly one page body.
 *
 * The glob rather than a plain import is the seam described in
 * src/shell/pageBody.ts: Integrate owns src/pages/HowItWorksPage.tsx, Shell owns this
...
const modules = import.meta.glob('./pages/HowItWorksPage.{tsx,jsx}', { eager: true });

hydrate('how-it-works.html', pickPage(modules, 'HowItWorksPage'));
