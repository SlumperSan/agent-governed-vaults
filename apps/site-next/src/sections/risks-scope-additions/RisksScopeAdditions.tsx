...
const ROWS: ReadonlyArray<{ key: string; term: string; body: string }> = [
  ...
  },
  {
    ...
    body:
      'Vendored third-party mathematics in the tree is under GPL-2.0-or-later and MIT terms in a repository whose own licence is MIT. The MIT half now matches the repository; the GPL-2.0-or-later half does not. That is a licensing question the owner has recorded as open, and it is disclosed here rather than left for you to find. It also stands as <a href="#r13">risk 13</a>.',
  },
