...
const HEADER = [
  ...
  ' *',
  ' *   r14  the 50,000 capacity cap',
  ' *     A parameter of vault #1, which exists on chain 4663, so "planned" is',
  ' *     the WRONG label for it now. Any page carrying the figure must carry',
  ' *     `capacityCapUsdc()` in the same markup instead; this cell supplies',
  ' *     both. See apps/site/test/site.test.mjs and its site-next twin, which',
  ' *     enforce that pairing and retired the "planned" one.',
  ' *',
