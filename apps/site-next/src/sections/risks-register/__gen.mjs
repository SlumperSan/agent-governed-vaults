...
const HEADER = [
  ...
  ' *',
  ' *   r14  "capacity cap is 50,000 USDG"',
  ' *     NO LONGER A PLANNED PARAMETER. capacityCapUsdc() reads 50000000000 on',
  ' *     both vaults on chain 4663 and is immutable, so the rule this comment',
  ' *     described has been INVERTED: a page carrying the figure must NOT call',
  ' *     it planned. The guard in apps/site/test/site.test.mjs and its twin in',
  ' *     apps/site-next/test/site.test.mjs now assert the absence of "planned"',
  ' *     within 240 characters of the figure, not its presence.',
  ' *',
