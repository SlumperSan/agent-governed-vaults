...
export const ENTRIES: readonly RiskEntry[] = [
  {
    ...
    rows: [
      { dt: "What it is", dd: "The contracts carry no proxy, no upgrade path, no pause and no admin key, and they are deployed on Robinhood Chain mainnet, broadcast on 2026-09-05. What runs is what runs, permanently." },
  ...
  },
  {
    ...
    rows: [
      ...
      { dt: "What is done", dd: "A capacity cap is a per-vault parameter. The two vaults on Robinhood Chain each set it to 50,000 USDG, so each vault's blast radius is bounded, but nothing bounds the protocol as a whole. Do not deposit what you cannot afford to lose entirely." },
    ],
  },
  {
    id: "r15",
