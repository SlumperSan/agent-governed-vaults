/**
 * Client entry for faq.html. One of eight; each is loaded by exactly one entry
 * HTML and pulls in exactly one page body.
 *
 * The glob rather than a plain import is the seam described in
 * src/shell/pageBody.ts: Integrate owns src/pages/FaqPage.tsx, Shell owns this
...
const modules = import.meta.glob('./pages/FaqPage.{tsx,jsx}', { eager: true });

hydrate('faq.html', pickPage(modules, 'FaqPage'));
