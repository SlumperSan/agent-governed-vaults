// AUTO-GENERATED by scripts/build-sdn-list.mjs — do not hand-edit. Re-run the script to refresh.
// @ts-check
...
export const SDN_ADDRESS_DATA = {
  ...
  digitalCurrencyIdTypesSeen: {
    ...
    "Digital Currency Address - ETH": 120,
    "Digital Currency Address - LTC": 14,
    "Digital Currency Address - ZEC": 4,
    "Digital Currency Address - DASH": 5,
    "Digital Currency Address - BTG": 1,
    "Digital Currency Address - ETC": 1,
    "Digital Currency Address - BSV": 1,
    "Digital Currency Address - BCH": 7,
    "Digital Currency Address - XVG": 1,
    "Digital Currency Address - XRP": 1,
    "Digital Currency Address - ARB": 1,
    "Digital Currency Address - BSC": 1,
    "Digital Currency Address - USDC": 2,
    "Digital Currency Address - SOL": 4,
    "Digital Currency Address - DOGE": 2,
    "Digital Currency Address - BNB": 1
  },
  addresses: [
